...
class Config:
    ...
    def __init__(self, **kwargs):
        ...
        self.SYSTEM_CONFIG = kwargs.get("SYSTEM_CONFIG", {
            ...
            "post_interval": int(os.getenv("POST_INTERVAL", "3600")),  # 發文間隔（秒）
            "reply_interval": int(os.getenv("REPLY_INTERVAL", "300")),  # 回覆間隔（秒）
            "max_daily_posts": int(os.getenv("MAX_DAILY_POSTS", "999")),   # 每日最大發文數（設為較大值進行測試）
            "max_daily_replies": int(os.getenv("MAX_DAILY_REPLIES", "50")),  # 每日最大回覆數
        ...
        self.SENTIMENT_WORDS = {
            "正面": ["開心", "興奮", "期待", "喜歡", "讚賞", "感動", "溫暖", "愉快", "滿意"],
            "中性": ["理解", "思考", "觀察", "好奇", "平靜", "普通", "一般", "還好"],
            "負面": ["生氣", "難過", "失望", "煩惱", "焦慮", "疲倦", "無聊", "不滿"]
        }
